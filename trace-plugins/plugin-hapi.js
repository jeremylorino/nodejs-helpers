        ...
        api.runInRootSpan(options, function (root) {
            ...
            res.end = function () {
                ...
                if (req.route && req.route.path) {
                    root.addLabel('hapi/request.route.path', req.route.path);
                }
...
module.exports = [
    {
        ...
        patch: function (hapi, api) {
            shimmer.wrap(hapi, 'Server', createConnectionWrap(api));
        },
